...
#define yydebug_init    ]b4_api_prefix[debug_init
#define yydebug_trace   ]b4_api_prefix[debug_trace
#define yydebug_stats   ]b4_api_prefix[debug_stats
#define yydebug_type    ]b4_api_prefix[debug_type
